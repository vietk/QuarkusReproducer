// Class: io/quarkus/deployment/steps/UndertowBuildStep$boot13
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$boot13#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 3
    AASTORE
    NEW io/quarkus/undertow/runtime/filters/CORSTemplate
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/undertow/runtime/filters/CORSTemplate#<init>
    ASTORE 4
    ALOAD 2
    LDC (Integer) 0
    ALOAD 4
    ...
    LDC (Integer) 0
    AALOAD
    CHECKCAST io/quarkus/undertow/runtime/filters/CORSTemplate
    ALOAD 5
    CHECKCAST io/quarkus/undertow/runtime/HttpConfig
    // Method descriptor: (Lio/quarkus/undertow/runtime/HttpConfig;)V
    INVOKEVIRTUAL io/quarkus/undertow/runtime/filters/CORSTemplate#setHttpConfig
    ...
    INVOKEVIRTUAL io/quarkus/undertow/runtime/UndertowDeploymentTemplate#startUndertow
    ASTORE 14
    ALOAD 1
