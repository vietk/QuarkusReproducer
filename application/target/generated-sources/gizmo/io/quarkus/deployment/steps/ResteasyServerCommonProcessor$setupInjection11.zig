...
(
    ...
    ** label1
    ...
    ALOAD 6
    AASTORE
    NEW io/quarkus/resteasy/server/common/runtime/ResteasyServerCommonTemplate
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/resteasy/server/common/runtime/ResteasyServerCommonTemplate#<init>
    ASTORE 8
    ALOAD 2
    LDC (Integer) 0
    ALOAD 8
