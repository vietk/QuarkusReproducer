// Class: io/quarkus/deployment/steps/ArcAnnotationProcessor$build8
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/arc/runtime/ArcDeploymentTemplate#getContainer
    ASTORE 5
    ALOAD 1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ArcAnnotationProcessor$build8#deploy_0
    RETURN
    ** label2
